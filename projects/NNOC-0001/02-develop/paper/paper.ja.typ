// --- frontmatter ---
#let title = "大型宿泊施設を核とした地域共存モデル"
#let fm = (
  "title": "大型宿泊施設を核とした地域共存モデル",
)
...
#quote(block: true)[
本研究では、旧約聖書における「詩篇」や賛美文化を、人類が共同体の中で歌い、祈り、感情を共有してきた文化的背景として参照した。 また、人類が古くから「死」や「祝福」「季節の節目」などを、単なる出来事ではなく、歌・祈り・儀式として共同体の中で共有してきた背景にも着目している。 本研究では、そのような行為は宗教的形式を超えて、人間が本来的に持っている「共に時間を過ごし、感情を分かち合おうとする性質」の一つである可能性を考察する上で参考とした。
...
Santa Claus: A Biography. McClelland & Stewart, 2005.
...
The Experience Economy. Harvard Business School Press, 1999.
...
Creative Tourism and Local Development. Creative Tourism: A Global Conversation, 2007.
...
The Great Good Place. Marlowe & Company, 1999.
